...
(function ($) {
    ...
    $.extend(FGTimepicker.prototype, {
        ...
        _connectTimepicker: function (target, inst) {
            ...
            input.addClass(this.markerClassName).on('keydown.timepicker', this._doKeyDown).on('keyup.timepicker', this._doKeyUp).on("setData.timepicker", function (event, key, value) {
        ...
        _inlineTimepicker: function (target, inst) {
            ...
            if (divSpan.hasClass(this.markerClassName))
                return;
            divSpan.addClass(this.markerClassName).append(inst.tpDiv).on("setData.timepicker", function (event, key, value) {
                inst.settings[key] = value;
            }).on("getData.timepicker", function (event, key) {
                return this._get(inst, key);
            });
        ...
        _showTimepicker: function (input) {
            ...
            inst.tpDiv.css({
                position: ($.fgtimepicker._inDialog && $.blockUI ?
        ...
        */
        ...
        selectHours: function (event) {
            ...
            if ($.fgtimepicker._isDisabledTimepicker($target.attr('id'))) {
                return false
            }
    ...
    $.fn.fgtimepicker = function (options) {
        ...
        if (!$.fgtimepicker.initialized) {
            $(document).on('mousedown.timepicker', $.fgtimepicker._checkExternalClick);
        ...
        if (typeof options == 'string' && (options == 'getTime' || options == 'getTimeAsDate' || options == 'getHour' || options == 'getMinute'))
            return $.fgtimepicker['_' + options + 'Timepicker'].apply($.fgtimepicker, [this[0]].concat(otherArgs));
        if (options == 'option' && arguments.length == 2 && typeof arguments[1] == 'string')
            return $.fgtimepicker['_' + options + 'Timepicker'].apply($.fgtimepicker, [this[0]].concat(otherArgs));
        return this.each(function () {
            typeof options == 'string' ?
                $.fgtimepicker['_' + options + 'Timepicker'].apply($.fgtimepicker, [this].concat(otherArgs)) :
