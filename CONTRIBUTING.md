...
### Detailed Java code quality standards:
  ...
  - All your code should compile and run in **Java 17**.
...
PrimeFaces Extensions Individual Contributor License Agreement
--------------------------------------------------

This contributor agreement ("Agreement") documents the rights granted by contributors to the PrimeFaces Extensions Project.

This is a legally binding document, so please read it carefully before agreeing to it. The Agreement
may cover more than one software project managed by PrimeFaces Extensions.

### 1. Definitions

  * _"PrimeFaces"_ means the "PrimeFaces Extensions Project organization and members".
...
#### 2.5 PrimeFaces Extensions Rights

You acknowledge that PrimeFaces Extensions is not obligated to use your Contribution as part of the
