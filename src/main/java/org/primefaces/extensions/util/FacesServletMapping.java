...
public class FacesServletMapping {
	...
	/** The path ("/faces", for example) which has been specified in the url-pattern of the FacesServlet mapping. */
	private String prefix;

	/** The extension (".jsf", for example) which has been specified in the url-pattern of the FacesServlet mapping. */
	private String extension;

	/**
	 * Creates a new FacesServletMapping object using prefix mapping.
	 *
	 * @param  path The path ("/faces", for example) which has been specified in the url-pattern of the FacesServlet mapping.
	 ...
	 *
	 * @param  extension The extension (".jsf", for example) which has been specified in the url-pattern of the FacesServlet
	 *                   mapping.
	 * @return a newly created FacesServletMapping
	 */
	...
	/**
	 * Returns the path ("/faces", for example) which has been specified in the url-pattern of the FacesServlet mapping. If this
	 * mapping is based on an extension, <code>null</code> will be returned. Note that this path is not the same as the specified
	 * url-pattern as the trailing "/*" is omitted.
	 *
	...
	/**
	 * Returns the extension (".jsf", for example) which has been specified in the url-pattern of the FacesServlet mapping. If
	 * this mapping is not based on an extension, <code>null</code> will be returned.
	 *
	 ...
	 *
	 * @return <code>true</code>, if this mapping is based is on an extension, <code>false</code> otherwise
	 */
	 ...
	 *
	 * @return <code>true</code>, if this mapping is based is on a prefix, <code>false</code> otherwise
	 */
	...
	protected static final String CACHED_SERVLET_MAPPING = "PFE_CACHED_FACES_SERVLET_MAPPING";

	/**
	 * Read the web.xml file that is in the classpath and parse its internals to figure out how the FacesServlet is mapped for the
	 * current webapp.
	 *
	 * @param  context DOCUMENT_ME
	 * @return DOCUMENT_ME
	 */
	public static FacesServletMapping getFacesServletMapping(FacesContext context) {
		...
		if (mapping == null) {
			...
			mapping = calculateFacesServletMapping(externalContext.getRequestServletPath(), externalContext.getRequestPathInfo());
	...
	/**
	 * Determines the mapping of the FacesServlet in the web.xml configuration file. However, there is no need to actually parse
	 * this configuration file as runtime information is sufficient.
	 *
