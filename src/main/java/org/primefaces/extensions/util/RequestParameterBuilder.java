...
public class RequestParameterBuilder {
	 ...
	 *
	 * @param url           URL
	 * @param jsonConverter specific JsonConverter. It should extends {@link JsonConverter} from PrimeFaces Extensions. If null,
	 *                      the default implementation {@link JsonExposeAwareConverter} is used.
	 */
	...
	/**
	 * Adds a request parameter to the URL without specifying a data type of the given parameter value. Parameter's value is
	 * converted to JSON notation when adding. Furthermore, it will be encoded according to the acquired encoding.
	 *
	 ...
	 * required, especially for Java generic types, because type information is erased at runtime and the conversion to JSON will
	 * not work properly. Parameter's value is converted to JSON notation when adding. Furthermore, it will be encoded according
	 * to the acquired encoding.
	 *
	 * @param  name  name of the request parameter
	 * @param  value value of the request parameter
	 * @param  type  data type of the value object. Any primitive type, array, non generic or generic type is supported. Data type
	 ...
	 *               "java.util.Collection<java.lang.Integer>" "java.util.Map<java.lang.String,
	 *               com.durr.FooPair<java.lang.Integer, java.util.Date>>" "com.durr.FooNonGenericClass"
	 *               "com.durr.FooGenericClass<java.lang.String, java.lang.Integer>" "com.durr.FooGenericClass<int[],
	...
	/**
	 * Adds a request parameter to the URL. This is a convenient method for primitive, plain data types. Parameter's value will
	 * not be converted to JSON notation when adding. It will be only encoded according to the acquired encoding. Note: null
	...
	/**
	 * Encodes given value with a proper encoding. This is a convenient method for primitive, plain data types. Value will not be
	 * converted to JSON. Note: Value can be null.
	 *
	...
	/**
	 * Convertes give value to JSON and encodes the converted value with a proper encoding. Data type is sometimes required,
	 * especially for Java generic types, because type information is erased at runtime and the conversion to JSON will not work
	 * properly.
	 *
