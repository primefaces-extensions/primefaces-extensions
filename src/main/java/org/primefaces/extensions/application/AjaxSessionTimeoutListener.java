...
/**
 * This class provides the possibility to deal with session timeouts and ajax requests in a user friendly way. Typically you would write a timeout.xhtml in
 * which you inform the user and provide a link or meta refresh to a protected page, override {@link #getTimeoutPath(javax.servlet.http.HttpServletRequest) }
 ...
 * <li>In this method a redirect is done to {@link #getTimeoutPath(javax.servlet.http.HttpServletRequest) }, which should be a <strong>protected</strong> page,
 * possibly via a non-protected page using meta refresh and showing some friendly message</li>
 ...
 *
 * @author https://github.com/eduarddrenth
 * @since 7.1
 */
public class AjaxSessionTimeoutListener implements PhaseListener {
    ...
    /**
     * If this is a {@link DispatcherType#FORWARD} to {@link #getLoginPath() } and the response hasn't been rendered yet, call
     * {@link #handleAjaxAfterTimeout(javax.faces.context.FacesContext, javax.servlet.http.HttpServletRequest) }.
     *
     * @param event the PhaseEvent of the JSF lifecycle
     */
    @Override
    ...
    /**
     * This implementation returns to the context path root, you may choose to override and redirect to a "timeout.xhtml" where you provide users some info and
     * options
     *
     * @return the path when timeout occurs
     */
