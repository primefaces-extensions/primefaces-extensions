...
public class InputNumber extends HtmlInputText implements Widget {
	...
	public String getWidgetVar() {
		return (String) getStateHelper().eval(org.primefaces.extensions.component.inputnumber.InputNumber.PropertyKeys.widgetVar, null);
	}

	public void setWidgetVar(final String widgetVar) {
		setAttribute(org.primefaces.extensions.component.inputnumber.InputNumber.PropertyKeys.widgetVar, widgetVar);
	}
