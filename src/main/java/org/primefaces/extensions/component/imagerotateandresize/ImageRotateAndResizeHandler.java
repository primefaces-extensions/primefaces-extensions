...
public class ImageRotateAndResizeHandler extends ComponentHandler {

	public ImageRotateAndResizeHandler(ComponentConfig config) {
		super(config);
	}
	...
	protected MetaRuleset createMetaRuleset(Class type) {
		...
		metaRuleset.addRule(new MethodRule("rotateListener", null, new Class[]{RotationEvent.class}));
